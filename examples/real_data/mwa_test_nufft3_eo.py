...
ms_file = "/work/ska/orliac/test_shreyam/1133149192-169-170_Sun_10s_cal.ms"
          #"/scratch/izar/krishna/MWA/MS_Files/1133149192-169-170_Sun_10s_cal.ms"
          #"/work/ska/MeerKAT/1569274256_sdp_l0_wtspec_J0159.0-3413.ms"
...
cl_WCS = ifits.wcs("/work/ska/orliac/test_shreyam/1133149192-169-170_Sun_10s_cal.ms_WSClean-image.fits")
          #ifits.wcs("/scratch/izar/krishna/MWA/WSClean/1133149192-169-170_Sun_10s_cal.ms_WSClean-image.fits")
          #ifits.wcs("/work/ska/MWA_1086366992/wsclean-mwa-chan100-image.fits")
ms = measurement_set.MwaMeasurementSet(ms_file) # stations 1 - N_station 

use_ms = True # Use UVW baselines from .ms file
use_raw_vis = False # Use visibilities from .ms file
do3D = True # 3D NUFFT 
doPlan = False # ??
ITRS_XYZ = True # True for ITRS, false for rascil
for do3D in True, False: 
