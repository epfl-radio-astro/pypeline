...
# Instrument
N_station = 37
ms_file = "/scratch/etolley/bluebild_test_data/results/ska-pipeline_simulation_0.ms"
ms = measurement_set.SKALowMeasurementSet(ms_file, N_station) # stations 1 - N_station 
